#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):47185920:03c86907fdc116f5c410d299995e258bdeaed383; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/by-name/boot$(getprop ro.boot.slot_suffix):33554432:97f0025fbe8eaebb2db7fd1761e81482eb5499ea \
          --target EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):47185920:03c86907fdc116f5c410d299995e258bdeaed383 && \
